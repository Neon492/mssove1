    ...
    public class UnitTest1
    {
        ...
        public void TestMethod1()
        {
            try
            {
                ...
                Console.WriteLine();
                IStreamCryptography cryptography = new VigenereCryptography();
                for (int i = 0; i < 20; i++)
                {
        ...
        public void TestMethod2()
        {
            try
            {
                Console.WriteLine(@"Тройной шифр Виженера");
                Console.WriteLine();
                IStreamCryptography cryptography = new Vigenere3Cryptography();
                for (int i = 0; i < 20; i++)
                {
                    string key = keys[i%keys.Length];
                    string text = texts[i%texts.Length];
