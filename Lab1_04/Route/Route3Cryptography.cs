...
{
    /// <summary>
    ///     Тройной шифр маршрутной перестановки
    ///     Шифратор из последовательно соединённых трёх шифраторов с шифром маршрутной перестановки
    ...
    /// </summary>
    public class Route3Cryptography : ICryptography
    {
        private readonly RouteCryptography _cryptography1 = new RouteCryptography();
        private readonly RouteCryptography _cryptography2 = new RouteCryptography();
        private readonly RouteCryptography _cryptography3 = new RouteCryptography();
