...
{
    /// <summary>
    ///     Тройной шифр вертикальной перестановки
    ///     Шифратор из последовательно соединённых трёх шифраторов с шифром вертикальной перестановки
    ...
    /// </summary>
    public class Vertical3Cryptography : ICryptography
    {
        private readonly VerticalCryptography _cryptography1 = new VerticalCryptography();
        private readonly VerticalCryptography _cryptography2 = new VerticalCryptography();
        private readonly VerticalCryptography _cryptography3 = new VerticalCryptography();
        ...
        private void SplitKey(string keyText, out string keyText1, out string keyText2, out string keyText3)
        {
            ...
            if (keys.Length != 3) throw new VerticalCryptography.WrongKeyException();
            keyText1 = keys[0];
            keyText2 = keys[1];
            keyText3 = keys[2];
        }
